...
client = Bot(description="DarkBot Bot is best", command_prefix="cartel " pm_help = True)
client.remove_command('help')


async def status_task():
    while True:
        await client.change_presence(game=discord.Game(name='for cartelhelp'))
